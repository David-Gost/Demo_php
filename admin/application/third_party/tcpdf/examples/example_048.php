...
$tbl = <<<EOD
<div class="table-responsive"><table cellspacing="0" cellpadding="1" border="1">
    <tr>
...
$tbl = <<<EOD
<div class="table-responsive"><table border="1" cellpadding="2" cellspacing="2">
<thead>
...
$tbl = <<<EOD
<div class="table-responsive"><table border="1" cellpadding="2" cellspacing="2" nobr="true">
 <tr>
...
$tbl = <<<EOD
<div class="table-responsive"><table border="1" cellpadding="2" cellspacing="2" align="center">
 <tr nobr="true">
