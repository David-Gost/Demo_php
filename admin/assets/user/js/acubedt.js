    ...
    appendEls = function () {
        return $('.js-clock').each(function () {
            ...
            while (k <= end) {
                ...
                $el.append('<div class="dial"><span class="time_frame">' + k + '</span><span class="time_frame">' + l + '</span>');
                k++;
            }
            $el.prepend('<div class="dial"><span class="time_frame">0</span><span class="time_frame">0</span></div>');
            $el.append('<div class="dial dial--last"><span class="time_frame">0</span><span class="time_frame">0</span></div>');
