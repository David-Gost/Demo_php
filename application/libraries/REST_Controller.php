...
abstract class REST_Controller extends CI_Controller
{
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        if (!method_exists($this, $controller_method)) {
            $this->setResult_message($this->lang->line('text_rest_unknown_method'));
            $this->response(
                $this->getResult_data()
    ...
    public $result_message = array();

    public function setResult_message($msg = "")
    {
    ...
    public function getResult_data()
    {
        ...
        $result_data->message = $this->result_message;
        $result_data->data = $this->result_data;
